  ...
  switch (errorType) {
    case PendingModalError.TOKEN_APPROVAL_ERROR:
      return {
        ...
        message: (
          <Trans>
            This provides the Nexis Network access to your token for trading. For security, it expires after 30 days.
          </Trans>
        ),
    ...
    case PendingModalError.WRAP_ERROR:
      return {
        ...
        message: (
          <Trans>
            Swaps on the Nexis Network can start and end with ETH. However, during the swap ETH is wrapped into WETH.
          </Trans>
        ),
