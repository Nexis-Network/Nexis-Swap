...
public struct ColorExtraction {
  ...
  static let specialCaseTokenColors: [String: UIColor] = [
    // old WBTC
    "https://raw.githubusercontent.com/Nexis/assets/master/blockchains/ethereum/assets/0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599/logo.png":
      UIColor(Color.WBTC),
    // new WBTC
    ...
    "https://raw.githubusercontent.com/Nexis/assets/master/blockchains/ethereum/assets/0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984/logo.png":
      UIColor(Color.UNI),
    // BUSD
    "https://raw.githubusercontent.com/Nexis/assets/master/blockchains/ethereum/assets/0x4Fabb145d64652a948d72533023f6E7A623C7C53/logo.png":
      UIColor(Color.BUSD),
    // AI-X
    ...
    // PEPE
    "https://raw.githubusercontent.com/Nexis/assets/master/blockchains/ethereum/assets/0x6982508145454Ce325dDbE47a25d4ec3d2311933/logo.png":
      UIColor(Color.PEPE),
    // APE
    "https://raw.githubusercontent.com/Nexis/assets/master/blockchains/ethereum/assets/0x4d224452801ACEd8B2F0aebE155379bb5D594381/logo.png":
      UIColor(Color.APE),
    // UNIBOT v2
    ...
    "https://assets.coingecko.com/coins/images/30462/small/logonoline_%281%29.png?1687510315":
      UIColor(Color.UNIBOT),
    // USDC
    "https://raw.githubusercontent.com/Nexis/assets/master/blockchains/ethereum/assets/0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48/logo.png":
      UIColor(Color.USDC),
    // HEX
    "https://raw.githubusercontent.com/Nexis/assets/master/blockchains/ethereum/assets/0x2b591e99afE9f32eAA6214f7B7629768c40Eeb39/logo.png":
      UIColor(Color.HEX),
    // MONG
    "https://raw.githubusercontent.com/Nexis/assets/master/blockchains/ethereum/assets/0x1ce270557C1f68Cfb577b856766310Bf8B47FD9C/logo.png":
      UIColor(Color.MONG),
    // ARB
    "https://raw.githubusercontent.com/Nexis/assets/master/blockchains/ethereum/assets/0xB50721BCf8d664c30412Cfbc6cf7a15145234ad1/logo.png":
      UIColor(Color.ARB),
    // Quant
    "https://raw.githubusercontent.com/Nexis/assets/master/blockchains/ethereum/assets/0x4a220E6096B25EADb88358cb44068A3248254675/logo.png":
      UIColor(Color.QNT),
    // Xen
    "https://raw.githubusercontent.com/Nexis/assets/master/blockchains/ethereum/assets/0x06450dEe7FD2Fb8E39061434BAbCFC05599a6Fb8/logo.png":
      UIColor(Color.XEN),
    // PSYOP
    "https://s2.coinmarketcap.com/static/img/coins/64x64/25422.png":
      UIColor(Color.PSYOP),
    // MATIC
    "https://raw.githubusercontent.com/Nexis/assets/master/blockchains/ethereum/assets/0x7D1AfA7B718fb893dB30A3aBc0Cfc608AaCfeBB0/logo.png":
      UIColor(Color.MATIC),
    // TURBO
    "https://raw.githubusercontent.com/Nexis/assets/master/blockchains/ethereum/assets/0xA35923162C49cF95e6BF26623385eb431ad920D3/logo.png":
      UIColor(Color.TURBO),
    // AIDOGE
    ...
    // MAKER
    "https://raw.githubusercontent.com/Nexis/assets/master/blockchains/ethereum/assets/0x9f8F72aA9304c8B593d555F12eF6589cC3A579A2/logo.png":
      UIColor(Color.MAKER),
    // OX
    ...
    "https://assets.coingecko.com/coins/images/19060/large/ANGLE_Token-light.png?1666774221":
      UIColor(Color.ANGLE),
    // GUSD
    "https://raw.githubusercontent.com/Nexis/assets/master/blockchains/ethereum/assets/0x056Fd409E1d7A124BD7017459dFEa2F387b6d5Cd/logo.png":
      UIColor(Color.GUSD),
    // OGN
    "https://raw.githubusercontent.com/Nexis/assets/master/blockchains/ethereum/assets/0x8207c1FfC5B6804F6024322CcF34F29c3541Ae26/logo.png":
      UIColor(Color.OGN),
    // GALA
    "https://raw.githubusercontent.com/Nexis/assets/master/blockchains/ethereum/assets/0x15D4c048F83bd7e37d49eA4C83a07267Ec4203dA/logo.png":
      UIColor(Color.GALA),
    // RPL
    "https://raw.githubusercontent.com/Nexis/assets/master/blockchains/ethereum/assets/0xD33526068D116cE69F19A9ee46F0bd304F21A51f/logo.png":
      UIColor(Color.RPL),
    // FWB
    "https://raw.githubusercontent.com/Nexis/assets/master/blockchains/ethereum/assets/0x35bD01FC9d6D5D81CA9E055Db88Dc49aa2c699A8/logo.png":
      UIColor(Color.FWB)
  ]
