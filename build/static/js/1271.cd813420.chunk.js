...
`,Lt=ue.default.div.withConfig({displayName:"Landing__AddressButton",componentId:"sc-a764a7b8-8"})`
  padding: 2px 4px;
  border-radius: 8px;
  display: flex;
  justify-content: center;
  align-items: center;
  color: ${({theme:e})=>e.accent1};
`,zt=(0,ue.default)(me.dL).withConfig({displayName:"Landing__StyledExternalLink",componentId:"sc-a764a7b8-9"})`
  color: ${({theme:e})=>e.neutral1};
