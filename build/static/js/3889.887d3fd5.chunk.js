...
`;function M({value:e,onUserInput:n,onMax:t,showMaxButton:d,onCurrencySelect:u,currency:h,otherCurrency:y,id:g,currencySearchFilters:v,showCurrencyAmount:C,renderBalance:O,fiatValue:M,hideBalance:U=!1,pair:z=null,hideInput:V=!1,locked:G=!1,loading:F=!1,...L}){var Z,q,K,X,H;const[J,Q]=(0,p.useState)(!1),{account:Y,chainId:ee}=(0,a.useWeb3React)(),ne=(0,x._h)(Y??void 0,h??void 0),te=(0,m.useTheme)(),{formatCurrencyAmount:ie}=(0,b.Gb)(),re=(0,p.useCallback)((()=>{Q(!1)}),[Q]),oe=(0,c.EC)(ee);return(0,i.jsxs)($,{id:g,hideInput:V,...L,children:[!G&&(0,i.jsx)(i.Fragment,{children:(0,i.jsxs)(k,{hideInput:V,disabled:!oe,children:[(0,i.jsxs)(T,{style:V?{padding:"0",borderRadius:"8px"}:{},selected:!u,children:[!V&&(0,i.jsx)(B,{className:"token-amount-input",value:e,onUserInput:n,disabled:!oe,$loading:F,maxDecimals:null===(Z=h)||void 0===Z?void 0:Z.decimals}),(0,i.jsx)(W,{shouldFetchOnAccountUpdate:J,$fullWidth:V,children:(0,i.jsx)(P,{disabled:!oe,visible:void 0!==h,selected:!!h,hideInput:V,className:"open-currency-select-button",onClick:()=>{u&&Q(!0)},pointerEvents:u?void 0:"none",children:(0,i.jsxs)(E,{children:[(0,i.jsxs)(N.DA,{children:[z?(0,i.jsx)("span",{style:{marginRight:"0.5rem"},children:(0,i.jsx)(w.Z,{currency0:z.token0,currency1:z.token1,size:24,margin:!0})}):h&&(0,i.jsx)(_.Z,{style:{marginRight:"0.5rem"},currency:h,size:"24px"}),z?(0,i.jsxs)(R,{className:"pair-name-container",children:[null===(q=z)||void 0===q?void 0:q.token0.symbol,":",null===(K=z)||void 0===K?void 0:K.token1.symbol]}):(0,i.jsx)(R,{className:"token-symbol-container",active:Boolean(h&&h.symbol),children:(h&&h.symbol&&h.symbol.length>20?h.symbol.slice(0,4)+"..."+h.symbol.slice(h.symbol.length-5,h.symbol.length):null===(X=h)||void 0===X?void 0:X.symbol)||(0,i.jsx)(r.cC,{id:"T0Y2+3"})})]}),u&&(0,i.jsx)(S,{selected:!!h})]})})})]}),Boolean(!V&&!U&&h)&&(0,i.jsx)(A,{children:(0,i.jsxs)(N.m0,{children:[(0,i.jsx)(l.EG,{$loading:F,children:M&&(0,i.jsx)(j.x,{fiatValue:M})}),Y&&(0,i.jsxs)(N.DA,{style:{height:"17px"},children:[(0,i.jsx)(f.Tv.DeprecatedBody,{onClick:t,color:te.neutral3,fontWeight:535,fontSize:14,style:{display:"inline",cursor:"pointer"},children:Boolean(!U&&h&&ne)&&((null===(H=O)||void 0===H?void 0:H(ne))||(0,i.jsx)(r.cC,{id:"VuFd5C",values:{0:ie({amount:ne,type:b.sw.TokenNonTx})}}))}),Boolean(d&&ne)&&(0,i.jsx)(s.M8,{events:[o.TM.onClick],name:o.Q0.SWAP_MAX_TOKEN_AMOUNT_SELECTED,element:o.xo.MAX_TOKEN_AMOUNT_BUTTON,children:(0,i.jsx)(D,{onClick:t,children:(0,i.jsx)(r.cC,{id:"4HtGBb"})})})]})]})})]})}),u&&(0,i.jsx)(I.Z,{isOpen:J,onDismiss:re,onCurrencySelect:u,selectedCurrency:h,otherSelectedCurrency:y,showCurrencyAmount:C,currencySearchFilters:v})]})}},39753:(e,n,t)=>{t.d(n,{q:()=>_,w:()=>N});var i=t(92936),r=t(31017),o=t(88846),a=t(1347),s=t(21926),l=t(43454),d=t(6282),c=t(22953),u=t(47856),p=t(47632),m=t(31744),h=t(61152),f=t(54972),y=t(55874),b=t(94284);const g=h.default.div.withConfig({displayName:"NavigationTabs__Tabs",componentId:"sc-b673d9be-0"})`
  ${y.MG};
  align-items: center;
  border-radius: 3rem;
...
//# sourceMappingURL=3889.887d3fd5.chunk.js.map