...
`,Ne=(0,se.default)(ce.Tv.BodySmall).withConfig({displayName:"BagFooter__HelperText",componentId:"sc-671223d7-7"})`
  ...
  text-align: center;
  margin-bottom: 10px !important;
`,Ae=(0,se.default)(h.ZP).withConfig({displayName:"BagFooter__CurrencyInput",componentId:"sc-671223d7-8"})`
  gap: 8px;
  cursor: pointer;
`,Te=se.default.button.withConfig({displayName:"BagFooter__ActionButton",componentId:"sc-671223d7-9"})`
  display: flex;
...
`,jt=({top:e,show:t})=>(0,s.jsx)(Re.n,{marginX:"24",borderWidth:"1px",borderStyle:"solid",borderColor:"transparent",borderTopColor:e?"transparent":"surface3",borderBottomColor:e?"surface3":"transparent",opacity:t?"1":"0",transition:"250"}),yt=()=>{const{resetSellAssets:e,sellAssets:t}=(0,ze.Pc)((({reset:e,sellAssets:t})=>({resetSellAssets:e,sellAssets:t}))),{setProfilePageState:n}=(0,ze.aO)((({setProfilePageState:e})=>({setProfilePageState:e}))),{bagStatus:d,bagIsLocked:l,reset:c,bagExpanded:u,toggleBag:p,setBagExpanded:g}=(0,ze.cP)((e=>({...e,bagIsLocked:e.isLocked,uncheckedItemsInBag:e.itemsInBag}))),{uncheckedItemsInBag:x}=(0,ze.cP)((({itemsInBag:e})=>({uncheckedItemsInBag:e}))),m=(0,a.e5)(),h=(0,a._3)(),f=(0,a.GZ)(),I=(0,ze.dD)(),N=(0,S.useMemo)((()=>(0,F.G7)(x)),[x]),[A,T]=(0,S.useState)(!1),{userCanScroll:C,scrollRef:_,scrollProgress:v,scrollHandler:E}=(0,ze.uh)(),w=(0,S.useCallback)((()=>{g({bagExpanded:!1,manualClose:!0})}),[g]);(0,S.useEffect)((()=>{l&&!A&&T(!0)}),[l,A]);const b=N.length>0,j=N.length>0,y=t.length>0,O=Boolean(!m&&!j&&d===z.s.ADDING_TO_BAG||m&&!y),P=(0,S.useMemo)((()=>({...(0,F.Hj)(N.map((e=>e.asset)))})),[N]);return u&&f?(0,s.jsxs)(Se.h,{children:[(0,s.jsxs)(Et,{"data-testid":"nft-bag",raiseZIndex:I||A,isProfilePage:m,children:[(0,s.jsx)(ft,{numberOfAssets:m?t.length:N.length,closeBag:w,resetFlow:m?e:c,isProfilePage:m}),O&&(0,s.jsx)(At,{}),(0,s.jsx)(jt,{top:!0,show:C&&v>0}),(0,s.jsx)(Le.sg,{ref:_,className:"_1jcz50r1 rgw6ez2ef rgw6ez2jx rgw6ez1yr rgw6ez8ct",onScroll:E,gap:"12",children:m?(0,s.jsx)(Ct,{}):(0,s.jsx)(ut,{})}),b&&!m&&(0,s.jsx)(ke,{setModalIsOpen:T,eventProperties:P}),y&&m&&(0,s.jsx)(bt,{onClick:()=>{p(),n(z.HA.LISTING),(0,o._P)(i.Yz.NFT_PROFILE_PAGE_START_SELL,{list_quantity:t.length,collection_addresses:t.map((e=>e.asset_contract.address)),token_ids:t.map((e=>e.tokenId))})},children:(0,s.jsx)(r.cC,{id:"xGVfLh"})})]}),h?(0,s.jsx)(wt,{onClick:p}):A&&(0,s.jsx)(Be.a,{onClick:()=>l?void 0:T(!1)})]}):null}},70518:(e,t,n)=>{n.d(t,{a:()=>a,U:()=>o});var s=n(92936),r=n(15511),i=n(27519);n(8731);const o=e=>{e.stopPropagation(),e.nativeEvent.stopImmediatePropagation()},a=({onClick:e=r.Z})=>(0,s.jsx)(i.n,{className:"_199qdl71 rgw6ez3f3 rgw6ez343 rgw6ez17l rgw6ez1ef rgw6ez48r rgw6ez44l rgw6ez4u3",onClick:e})},52384:(e,t,n)=>{n.d(t,{B:()=>p,P:()=>u});var s=n(11604),r=n(66284),i=n(39671),o=n(32682),a=n(89882),d=n(47263),l=n(45779),c=n(64538);function u(){const e=(0,c.c)((e=>e.itemsInBag));return(0,l.useMemo)((()=>e.reduce(((e,t)=>t.status!==d.ZJ.UNAVAILABLE?e.add(s.O$.from(t.asset.updatedPriceInfo?t.asset.updatedPriceInfo.ETHPrice:t.asset.priceInfo.ETHPrice)):e),s.O$.from(0))),[e])}function p(){const e=u(),t=(0,i.U8)("ETH"),n=(0,l.useMemo)((()=>(0,a.Z)((0,r.formatEther)(e.toString()),t??void 0)),[t,e]),s=(0,o.sq)(n);return(0,l.useMemo)((()=>{var e;return null===(e=s)||void 0===e?void 0:e.toExact()}),[s])}}}]);
//# sourceMappingURL=3464.53a1ad7e.chunk.js.map