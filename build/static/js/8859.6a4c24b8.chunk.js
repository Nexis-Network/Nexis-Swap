...
`,C=(0,p.default)(h.a.div).withConfig({displayName:"Carousel__CarouselItemCard",componentId:"sc-718aa339-2"})`
  display: flex;
...
`,w=p.default.div.withConfig({displayName:"Carousel__CarouselItemIcon",componentId:"sc-718aa339-3"})`
  align-items: center;
...
`,y=800,b=({children:e,activeIndex:n,toggleNextSlide:i})=>{const t=(0,s.useCallback)(((n,i=e.length)=>(0,d.ef)(n,i)),[e]),o=(0,s.useCallback)(((e,n,i)=>(0,d.E)(e,n,i,t)),[t]),[r,l]=(0,h.bY)(e.length,(n=>({x:(n<e.length-1?n:-1)*y}))),c=(0,s.useRef)([0,1]),p=(0,s.useCallback)(((n,i)=>{const a=t(Math.floor(n/y)%e.length),r=i<0?e.length-2:1;l((t=>{const l=o(t,a,r),s=o(t,c.current[0],c.current[1]),p=(0,d.Z1)(a,r,l,e.length,n);return{x:-n%(y*e.length)+y*p,immediate:i<0?s>l:s<l,config:{tension:250,friction:30}}})),c.current=[a,r]}),[t,o,l,e.length]),u=(0,s.useRef)(0);(0,s.useEffect)((()=>{p(n*y,u.current)}),[n,p]);const b=(0,s.useCallback)((e=>{u.current=e,i(e)}),[i]);return(0,s.useEffect)((()=>{const e=setInterval(x((function*(){b(1)})),7e3);return()=>{clearInterval(e)}}),[b,n]),(0,a.jsxs)(g,{children:[(0,a.jsx)(w,{onClick:()=>b(-1),children:(0,a.jsx)(m.wy,{width:"16px",height:"16px"})}),(0,a.jsx)(f,{children:r.map((({x:n},i)=>(0,a.jsx)(C,{style:{x:n},children:e[i]},i)))}),(0,a.jsx)(w,{onClick:()=>b(1),children:(0,a.jsx)(m.XC,{width:"16px",height:"16px"})})]})},v=({children:e})=>(0,a.jsx)(b,{activeIndex:0,toggleNextSlide:()=>{},children:[e]});var j=i(32546),_=i(82743),T=i(13901),k=i(47263),N=i(68798),$=i(66136);const I=p.default.div.withConfig({displayName:"CarouselCard__CarouselCardBorder",componentId:"sc-ca85a8ee-0"})`
  width: 100%;
  position: relative;
  border-radius: 21px;
  cursor: pointer;
...
`,S=p.default.div.withConfig({displayName:"CarouselCard__CardHeaderContainer",componentId:"sc-ca85a8ee-1"})`
  position: relative;
  background-image: ${({src:e})=>`url(${e})`};
  background-size: cover;
  background-position: center;
`,H=p.default.div.withConfig({displayName:"CarouselCard__LoadingCardHeaderContainer",componentId:"sc-ca85a8ee-2"})`
  position: relative;
  ...
  background-size: 400%;
`,z=p.default.div.withConfig({displayName:"CarouselCard__CardHeaderColumn",componentId:"sc-ca85a8ee-3"})`
  position: relative;
  display: flex;
  flex: 1;
  align-items: center;
  ...
  padding: 0 40px;
  z-index: 1;
`,F=p.default.div.withConfig({displayName:"CarouselCard__IconContainer",componentId:"sc-ca85a8ee-4"})`
  display: inline-flex;
  vertical-align: text-bottom;
  margin-left: 2px;
  transform: translateY(-2px) translateX(2px);
`,E=p.default.div.withConfig({displayName:"CarouselCard__CollectionNameContainer",componentId:"sc-ca85a8ee-5"})`
  display: -webkit-box;
  overflow: hidden;
  ...
  text-align: center;
  max-height: 56px;
`,P=(0,p.default)(_.X).withConfig({displayName:"CarouselCard__LoadingCollectionNameContainer",componentId:"sc-ca85a8ee-6"})`
  width: 50%;
`,B=p.default.div.withConfig({displayName:"CarouselCard__HeaderOverlay",componentId:"sc-ca85a8ee-7"})`
...
`,D=p.default.img.withConfig({displayName:"CarouselCard__CollectionImage",componentId:"sc-ca85a8ee-8"})`
  width: 86px;
  height: 86px;
  background: ${({theme:e})=>e.deprecated_accentTextLightPrimary};
  border: 2px solid ${({theme:e})=>e.deprecated_accentTextLightPrimary};
  border-radius: 100px;
`,X=p.default.div.withConfig({displayName:"CarouselCard__LoadingCollectionImage",componentId:"sc-ca85a8ee-9"})`
  width: 86px;
  height: 86px;
  border-radius: 100px;
  animation: ${j.gz} 1.5s infinite;
  ...
  will-change: background-position;
  background-size: 400%;
`,O=(0,p.default)(_.X).withConfig({displayName:"CarouselCard__LoadingTableElement",componentId:"sc-ca85a8ee-10"})`
  width: 50px;
`,V=p.default.div.withConfig({displayName:"CarouselCard__TableElement",componentId:"sc-ca85a8ee-11"})`
  display: flex;
  align-items: center;
  gap: 6px;
`,L=p.default.div.withConfig({displayName:"CarouselCard__FirstColumnTextWrapper",componentId:"sc-ca85a8ee-12"})``,M=p.default.div.withConfig({displayName:"CarouselCard__CardBottomContainer",componentId:"sc-ca85a8ee-13"})`
  display: grid;
  flex: 1;
  gap: 8px;
  grid-template-columns: auto auto auto;
  padding: 16px 16px 20px;
`,R=p.default.img.withConfig({displayName:"CarouselCard__MarketplaceIcon",componentId:"sc-ca85a8ee-14"})`
  width: 20px;
  height: 20px;
`,G=p.default.div.withConfig({displayName:"CarouselCard__CarouselCardContainer",componentId:"sc-ca85a8ee-15"})`
  display: flex;
  flex-direction: column;
...
`,ge=p.default.div.withConfig({displayName:"Cells__EthContainer",componentId:"sc-6ddadcc7-7"})`
  display: flex;
  justify-content: flex-end;
`,fe=({value:e})=>{const n=(0,oe.dD)();return(0,a.jsxs)(ce,{children:[(0,a.jsx)(ue,{src:e.logo}),(0,a.jsx)(pe,{children:n?(0,a.jsx)(he,{children:e.name}):(0,a.jsx)(me,{children:e.name})}),e.isVerified&&(0,a.jsx)("span",{className:"rgw6ezl3 rgw6ez453 rgw6ez2o3 rgw6ez19r rgw6ez12r rgw6ez45x",children:(0,a.jsx)(m.SA,{})})]})},Ce=({value:e})=>{const{formatNumberOrString:n}=(0,$.Gb)();return(0,a.jsx)("span",{children:e.value?n({input:e.value,type:$.sw.NFTCollectionStats}):"-"})},we=(e,n,i,a)=>e===k.VG.ETH?i:a&&i?a*(n?parseFloat((0,le.formatEther)(i)):i):void 0,ye=({value:e,denomination:n,usdPrice:i})=>{const{formatNumberOrString:t}=(0,$.Gb)(),o=we(n,!1,e,i),r=n===k.VG.ETH,l=t({input:o,type:r?$.sw.NFTToken:$.sw.FiatTokenStats})+(r?" ETH":""),d=(0,oe.dD)()?re.Tv.BodySmall:re.Tv.BodyPrimary;return(0,a.jsx)(ge,{children:(0,a.jsx)(d,{children:e?l:"-"})})},be=({value:e})=>(0,a.jsx)(re.Tv.BodyPrimary,{children:e}),ve=({value:e,denomination:n,usdPrice:i})=>{const{formatNumberOrString:t}=(0,$.Gb)(),o=we(n,!1,e,i),r=n===k.VG.ETH,l=t({input:o,type:r?$.sw.WholeNumber:$.sw.FiatTokenStats})+(r?" ETH":"");return(0,a.jsx)(ge,{children:(0,a.jsx)(re.Tv.BodyPrimary,{children:l})})},je=({change:e,children:n})=>{const i=(0,oe.dD)()?re.Tv.BodySmall:re.Tv.BodyPrimary;return(0,a.jsxs)(xe,{change:e??0,children:[(0,a.jsx)(de.Kx,{delta:e}),(0,a.jsx)(i,{color:"currentColor",children:n||`${e?Math.abs(Math.round(e)):0}%`})]})};var _e=i(88846),Te=i(98643),ke=i(91527),Ne=i(96795),$e=i(40403),Ie=i(65851),Se="_1mor7veh rgw6ezd3 rgw6ezbf rgw6eze9 rgw6ez2of rgw6ez27x rgw6ez1jl rgw6ez463 rgw6ez48x",He="_1mor7vea rgw6ez4qf rgw6ez16r rgw6ez80x rgw6ez7zl",ze="_1mor7ved rgw6ezd3 rgw6ezb9 rgw6eze3 rgw6ez4bf rgw6ez2or rgw6ez289",Fe="rgw6ezr9 rgw6ez55f rgw6ez895 rgw6ez805";const Ee=p.default.div.withConfig({displayName:"Table__RankCellContainer",componentId:"sc-31220bfb-0"})`
  display: flex;
  align-items: center;
  padding-left: 24px;
  gap: 12px;
...
//# sourceMappingURL=8859.6a4c24b8.chunk.js.map